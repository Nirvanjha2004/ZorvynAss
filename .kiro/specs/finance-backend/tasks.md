...
- [ ] 4. Financial records
  - [-] 4.1 Implement records service and routes
  ...
  - [ ] 4.2 Write property tests for financial records
...
- [ ] 6. Dashboard summary APIs
  - [ ] 6.1 Implement dashboard service and routes
  ...
  - [ ] 6.2 Write property tests for dashboard
...
- [ ] 7. Validation and error handling
  - [ ] 7.1 Wire Zod validation into all routes
  ...
  - [ ] 7.2 Write property tests for validation and error structure
...
- [ ] 8. Wire everything together
  - [ ] 8.1 Create main app entry point
  ...
  - [ ] 8.2 Write integration smoke tests
